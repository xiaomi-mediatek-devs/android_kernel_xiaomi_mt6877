...
#define AF_DRVNAME "RUBY_OFILM_S5KHPX_DW9800VAF_DRV"
...
static int s4RUBY_OFILM_S5KHPX_DW9800VAF_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long RUBY_OFILM_S5KHPX_DW9800VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int RUBY_OFILM_S5KHPX_DW9800VAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int RUBY_OFILM_S5KHPX_DW9800VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
	...
	if (*g_pAF_Opened == 1) {
		initdrv();
		ret = s4RUBY_OFILM_S5KHPX_DW9800VAF_ReadReg(&InitPos);
...
int RUBY_OFILM_S5KHPX_DW9800VAF_GetFileName(unsigned char *pFileName)
{
